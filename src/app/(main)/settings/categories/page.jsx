...
export default function Categories() {
  ...
  const selectedSectionSing =
    selectedSection === "categories" ? "Category" : "Tag";
      ...
      <div className="py-3 px-2">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 max-h-[calc(100vh-330px)] overflow-auto">
          ...
          (selectedSection === "categories" ? errorCats : errorTags) ? (
            <MessageContainer
              title={`Error loading ${selectedSection}`}
              msg={errorCats || errorTags}
              type="error"
            />
          ) : items.length === 0 ? (
            // Empty
            <div className="col-span-full">
              <MessageContainer
                title={`No ${selectedSection} yet`}
                msg={`Add your first ${selectedSectionSing.toLocaleLowerCase()} to get started.`}
                type="empty"
              />
            </div>
          ) : (
