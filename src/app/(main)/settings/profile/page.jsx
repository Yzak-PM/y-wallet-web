  ...
  return (
    <div className="flex flex-col">
      <div className="flex justify-center">
        ...
        >
          <span className="font-medium text-white text-5xl">{!loadingUser && nameInitials}</span>
        </div>
      </div>
      <div className="text-center mt-4">
        {isEditing 
          ...
          <>
            <div className="grid grid-cols-1 gap-3">
              <div className="flex flex-col gap-1">
                <label className="ms-2 text-sm text-start font-medium">First name:</label>
                <CustomInput 
                  type="text"
                  ...
                  onChange={
                    (e) => {
                      ...
                      setNameInitials(formatNameInitials(e.target.value, form.lastName));
                    }
                  }
                />
                {fieldErrors.firstName &&
                  <p className="text-red-500 text-start text-xs ms-1">{fieldErrors.firstName}</p>
                }
              </div>
              <div className="flex flex-col gap-1">
                <label className="ms-2 text-sm text-start font-medium">Last name:</label>
                <CustomInput 
                  type="text"
                  value={form.lastName}
                  onChange={(e) => {
                    setForm(prev => ({ ...prev, lastName: e.target.value }));
                    setNameInitials(formatNameInitials(form.firstName, e.target.value));
                  }}
                />
                {fieldErrors.lastName &&
                  <p className="text-red-500 text-start text-xs ms-1">{fieldErrors.lastName}</p>
                }
              </div>
              <div className="flex flex-col gap-1">
                <label className="ms-2 text-sm text-start font-medium">Username:</label>
                <CustomInput 
                  type="text"
                  value={form.username}
                ...
                {fieldErrors.username &&
                  <p className="text-red-500 text-start text-xs ms-1">{fieldErrors.username}</p>
                }
              </div>
              <div className="flex flex-col gap-1">
                <label className="ms-2 text-sm text-start font-medium">Email:</label>
                <CustomInput 
                  type="email"
                  value={form.email}
                ...
                />
                {fieldErrors.email && 
                  <p className="text-red-500 text-start text-xs ms-1">{fieldErrors.email}</p>
                }
              </div>
            </div>
            <div className="mt-5 flex justify-center items-center gap-2">
              <button 
                onClick={() => {
                  setIsEditing(false);
                  setNameInitials(formatNameInitials(user?.first_name, user?.last_name));
                }}
              ...
              <button 
                ...
                {loadingPost 
                  ...
                  : <span className="flex items-center"><SaveIcon className="me-2" /> Save Changes</span>
                }
              </button>
            </div>
          </>
          ...
          <>
            ...
            ?
              <>
                <SimpleSkeleton position="center" width="30" className="h-4 mb-2" /> 
                <SimpleSkeleton position="center" width="45" className="h-4 mb-2"/> 
                <SimpleSkeleton position="center" width="20" className="h-4 mb-2"/> 
              </>
            :
              <>
            ...
            <button 
              ...
              <span className="flex"><PencilIcon className="me-2" /> Edit account</span>
            </button>
          </>
        }
      </div>
